$(document).ready(function(){
	...
	$('#addToVhcls').click(function(){
		...
		setCookie()
		$("#vhclsTbl").html('<tr><td style="text-align:center;"><img src="Images/'+pgNm+'/loading.gif" height="50" width="50" alt="loading" text="please wait..." /><br /><i>Found: <span class="numFound">0 certificat</span></i></td></tr>');
