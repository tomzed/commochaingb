...
$(document).ready(function(){
    ...
    if(blockNum > 0) //If not the genesis block..
    {
        ...
        $('#blockScroll').prepend('<div class="singleBlockContainer"><div class="exBlock notClicked" onclick="changeShape(this)"><span>'+blockNum+'</span></div><br /><div class="triangle_down_big"></div><div class="triangle_down"></div><div class="blockData"><span class="blockHash"></span><br /><br /><span class="prevHash"><b>Hash du bloc précédent: </b><br />'+block.previousBlockHash+'</span><br /><br /><span class="blockTimeAdded"><b>Added to Chain: </b><br />'+timeConverter(block.nonHashData.localLedgerCommitTimestamp.seconds)+'</span><br />'+transSpans+'</div><input type="hidden" class="height" value="'+(351+(39*block.transactions.length))+'"></input></div>');
		...
		blk.transactions = blk.transactions || [];
                ...
                if (block.transactions) {
                    ...
                    $('#blockScroll').prepend('<div class="singleBlockContainer"><div class="exBlock notClicked" onclick="changeShape(this)"><span>'+(blockNum-i)+'</span></div><br /><div class="triangle_down_big"></div><div class="triangle_down"></div><div class="blockData"><span class="blockHash"><b>Hash du Bloc: </b><br />'+lastBlockHash+'</span><br /><br /><span class="prevHash"><b>Hash du bloc précédent: </b><br />'+blk.previousBlockHash+'</span><br /><br /><span class="blockTimeAdded"><b>Ajouté à la chaîne le: </b><br />'+timeConverter(blk.nonHashData.localLedgerCommitTimestamp.seconds)+'</span><br />'+transSpans+'</div><input type="hidden" class="height" value="'+(351+(39*blk.transactions.length))+'"></input></div>');
                }
            ...
            else if(blockNum - i == 0) //If genesis block..
            {
                ...
                $('#blockScroll').prepend('<div class="singleBlockContainer"><div class="exBlock notClicked" onclick="changeShape(this)"><span>'+(blockNum-i)+'</span></div><br /><div class="triangle_down_big"></div><div class="triangle_down"></div><div class="blockData"><span class="blockHash"><b>Hash du Bloc: </b><br />'+lastBlockHash+'</span><br /><br /><span class="blockTimeAdded"><b>Ajouté à la chaîne le: </b><br />'+timeConverter(blk.nonHashData.localLedgerCommitTimestamp.seconds)+'</span><br /><br /><span class="blocksTransactionsHdr" >Transactions:</span><br /><span class="blocksTransactions">No transactions in the Genesis block.</span></div><input type="hidden" class="height" value="'+270+'"></input></div>');
            }
            else
            {
                break;
    ...
    else
    {
        ...
        $('#blockScroll').prepend('<div class="singleBlockContainer"><div class="exBlock notClicked" onclick="changeShape(this)"><span>'+blockNum+'</span></div><br /><div class="triangle_down_big"></div><div class="triangle_down"></div><div class="blockData"><span class="blockHash">Pas de Hash pour le bloc de génèse</span><br /><br /><span class="blockTimeAdded"><b>Ajouté à la chaîne le: </b><br />'+timeConverter(block.nonHashData.localLedgerCommitTimestamp.seconds)+'</span><br />'+transSpans+'</div><input type="hidden" class="height" value="'+270+'"></input></div>');
    }
    ...
    {
        $('#blockScroll').prepend('<div class="singleBlockContainer"><div class="exBlock notClicked noData" onclick="changeShape(this)"><span>'+(i)+'</span></div><br /><div class="triangle_down_big"></div><div class="triangle_down"></div><div class="blockData" style="text-align:center" ><span><img src="Images/loading.gif" style="margin-top:10px; padding:10px" height="50" width="50" /><br />Entrain de charger le bloc...</span></div><input type="hidden" class="height" value="110"></input></div>');
    }
...
function updatePage()
{
    ...
    if(storeBlock < blockNum) //If latest block number is less than chain height
    {
        ...
        $('#blockScroll').append('<div class="singleBlockContainer"><div class="exBlock notClicked" onclick="changeShape(this)"><span>'+(blockNum)+'</span></div><br /><div class="triangle_down_big"></div><div class="triangle_down"></div><div class="blockData"><span class="blockHash"><b>Hash du bloc: </b><br />'+lastBlockHash+'</span><br /><br /><span class="prevHash"><b>Hash du bloc précédent: </b><br />'+block.previousBlockHash+'</span><br /><br /><span class="blockTimeAdded"><b>Ajouté à la chaîne le: </b><br />'+timeConverter(block.nonHashData.localLedgerCommitTimestamp.seconds)+'</span><br />'+transSpans+'</div><input type="hidden" class="height" value="'+(351+(39*block.transactions.length))+'"></input></div>');
...
function getBlockData(number, el)
{
    ...
    if(number === 0)
    {
        ...
        $(el).html('<span class="blockHash" style="display:inline-block"><b>Hash du bloc: </b><br />'+lastBlockHash+'</span><br /><br /><span class="blockTimeAdded"  style="display:inline-block"><b>Ajouté à la chaîne le: </b><br />'+timeConverter(block.nonHashData.localLedgerCommitTimestamp.seconds)+'</span><br /><br /><span style="display:inline-block" class="blocksTransactionsHdr" >Transactions:</span><br /><span class="blocksTransactions" style="display:inline-block">Pas de transaction dans le bloc de génèse.</span>');
    ...
    else
    {
        ...
        $(el).html('<span class="blockHash" style="display:inline-block"><b>Hash du bloc: </b><br />'+lastBlockHash+'</span><br /><br /><span class="prevHash" style="display:inline-block"><b>Hash du précédent bloc: </b><br />'+block.previousBlockHash+'</span><br /><br /><span class="blockTimeAdded"  style="display:inline-block"><b>Ajouté à la chaîne le: </b><br />'+timeConverter(block.nonHashData.localLedgerCommitTimestamp.seconds)+'</span><br />'+transSpans);
        $(el).css('text-align', 'left');
