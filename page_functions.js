        ...
        */
        ...
        if($('#selVhclsTbl tr').length >= 1 && $('#recipientInfo').html() != '') {
            ...
            $('#selVhclsTbl tr').each(function() {
                ...
                $('#confTxt').html('Transaction inscrite dans la chaîne de bloc. <br /><br />Manufacturer: '+getCookie('user')+'<br /><br />'+recDets+': '+$('.delName').html()+' (Account '+$('.accAddr').html()+')<br /><br />Vehicles: '+$('#selVhclsTbl tr').length);
        ...
        */
        ...
        if($('#selVhclsTbl tr').length >= 1) {
            ...
            $('#selVhclsTbl tr').each(function() {
                ...
                $('#confTxt').html('Transaction inscrite dans la chaîne de bloc. <br /><br />Scrap Merchant: '+getCookie('user')+'<br /><br />Vehicles: '+$('#selVhclsTbl tr').length);
